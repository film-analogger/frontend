...
```typescript
import { ChemistryTypeJsonldReadChemistryTypeTranslatableReadTimestampableBlameableRead } from './api';

const instance: ChemistryTypeJsonldReadChemistryTypeTranslatableReadTimestampableBlameableRead = {
    context,
    id,
    type,
    id,
