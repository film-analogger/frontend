# ExposureJsonldReadPrintTimestampableBlameableRead
...
```typescript
import { ExposureJsonldReadPrintTimestampableBlameableRead } from './api';

const instance: ExposureJsonldReadPrintTimestampableBlameableRead = {
    id,
    order,
    kind,
    baseSeconds,
