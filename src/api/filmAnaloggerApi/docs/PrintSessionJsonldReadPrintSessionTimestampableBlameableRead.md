...
```typescript
import { PrintSessionJsonldReadPrintSessionTimestampableBlameableRead } from './api';

const instance: PrintSessionJsonldReadPrintSessionTimestampableBlameableRead = {
    context,
    id,
    type,
    id,
