# FilmReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
**manufacturer** | [**ManufacturerReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead**](ManufacturerReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead.md) |  | [default to undefined]
...
```typescript
import { FilmReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: FilmReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    name,
    description,
    process,
