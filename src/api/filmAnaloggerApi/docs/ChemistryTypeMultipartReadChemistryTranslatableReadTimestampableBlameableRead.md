# ChemistryTypeMultipartReadChemistryTranslatableReadTimestampableBlameableRead
...
```typescript
import { ChemistryTypeMultipartReadChemistryTranslatableReadTimestampableBlameableRead } from './api';

const instance: ChemistryTypeMultipartReadChemistryTranslatableReadTimestampableBlameableRead = {
    id,
    typeCode,
    typeLabel,
    translations,
