# ManufacturerJsonldReadPhotoPaperTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerJsonldReadPhotoPaperTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerJsonldReadPhotoPaperTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    id,
