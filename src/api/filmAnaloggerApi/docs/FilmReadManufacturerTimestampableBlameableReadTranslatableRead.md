# FilmReadManufacturerTimestampableBlameableReadTranslatableRead
...
```typescript
import { FilmReadManufacturerTimestampableBlameableReadTranslatableRead } from './api';

const instance: FilmReadManufacturerTimestampableBlameableReadTranslatableRead = {
    translations,
    isTranslated,
    createdBy,
    updatedBy,
