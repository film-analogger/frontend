# ManufacturerReadEnlargerTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerReadEnlargerTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerReadEnlargerTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    name,
    primaryColor,
    secondaryColor,
