...
**manufacturer** | [**ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableRead**](ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableRead.md) |  | [default to undefined]
...
```typescript
import { FilmJsonldReadFilmTranslatableReadTimestampableBlameableRead } from './api';

const instance: FilmJsonldReadFilmTranslatableReadTimestampableBlameableRead = {
    context,
    id,
    type,
    id,
