# TagReadTagTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { TagReadTagTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: TagReadTagTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    name,
    description,
    primaryColor,
