# ExposureMultipartReadPrintTimestampableBlameableRead
...
```typescript
import { ExposureMultipartReadPrintTimestampableBlameableRead } from './api';

const instance: ExposureMultipartReadPrintTimestampableBlameableRead = {
    id,
    order,
    kind,
    baseSeconds,
