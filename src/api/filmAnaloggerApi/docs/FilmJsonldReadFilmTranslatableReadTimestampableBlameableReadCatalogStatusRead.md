...
**manufacturer** | [**ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead**](ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead.md) |  | [default to undefined]
...
```typescript
import { FilmJsonldReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: FilmJsonldReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    id,
