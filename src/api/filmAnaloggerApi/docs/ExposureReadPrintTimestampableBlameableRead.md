# ExposureReadPrintTimestampableBlameableRead
...
```typescript
import { ExposureReadPrintTimestampableBlameableRead } from './api';

const instance: ExposureReadPrintTimestampableBlameableRead = {
    id,
    order,
    kind,
    baseSeconds,
