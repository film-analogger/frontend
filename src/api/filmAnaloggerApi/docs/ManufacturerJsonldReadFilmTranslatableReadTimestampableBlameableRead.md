# ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableRead
...
```typescript
import { ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableRead } from './api';

const instance: ManufacturerJsonldReadFilmTranslatableReadTimestampableBlameableRead = {
    context,
    id,
    type,
    id,
