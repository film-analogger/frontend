# ChemistryTypeJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ChemistryTypeJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ChemistryTypeJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    id,
