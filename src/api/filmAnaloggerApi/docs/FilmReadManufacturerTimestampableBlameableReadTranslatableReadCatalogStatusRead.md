# FilmReadManufacturerTimestampableBlameableReadTranslatableReadCatalogStatusRead
...
```typescript
import { FilmReadManufacturerTimestampableBlameableReadTranslatableReadCatalogStatusRead } from './api';

const instance: FilmReadManufacturerTimestampableBlameableReadTranslatableReadCatalogStatusRead = {
    createdBy,
    updatedBy,
    createdAt,
    updatedAt,
