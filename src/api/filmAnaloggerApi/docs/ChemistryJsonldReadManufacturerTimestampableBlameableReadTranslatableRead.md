# ChemistryJsonldReadManufacturerTimestampableBlameableReadTranslatableRead
...
```typescript
import { ChemistryJsonldReadManufacturerTimestampableBlameableReadTranslatableRead } from './api';

const instance: ChemistryJsonldReadManufacturerTimestampableBlameableReadTranslatableRead = {
    context,
    id,
    type,
    translations,
