# ChemistryTypeReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ChemistryTypeReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ChemistryTypeReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    typeCode,
    typeLabel,
    translations,
