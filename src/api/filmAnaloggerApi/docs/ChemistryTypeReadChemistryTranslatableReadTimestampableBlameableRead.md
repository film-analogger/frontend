# ChemistryTypeReadChemistryTranslatableReadTimestampableBlameableRead
...
```typescript
import { ChemistryTypeReadChemistryTranslatableReadTimestampableBlameableRead } from './api';

const instance: ChemistryTypeReadChemistryTranslatableReadTimestampableBlameableRead = {
    id,
    typeCode,
    typeLabel,
    translations,
