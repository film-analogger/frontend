# ManufacturerMultipartReadChemistryTranslatableReadTimestampableBlameableRead
...
```typescript
import { ManufacturerMultipartReadChemistryTranslatableReadTimestampableBlameableRead } from './api';

const instance: ManufacturerMultipartReadChemistryTranslatableReadTimestampableBlameableRead = {
    name,
    primaryColor,
    secondaryColor,
    tertiaryColor,
