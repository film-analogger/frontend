# ChemistryTypeReadChemistryTypeTranslatableReadTimestampableBlameableRead
...
```typescript
import { ChemistryTypeReadChemistryTypeTranslatableReadTimestampableBlameableRead } from './api';

const instance: ChemistryTypeReadChemistryTypeTranslatableReadTimestampableBlameableRead = {
    id,
    process,
    typeCode,
    typeLabel,
