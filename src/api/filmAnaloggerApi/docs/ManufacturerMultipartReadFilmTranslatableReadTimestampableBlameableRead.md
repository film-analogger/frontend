# ManufacturerMultipartReadFilmTranslatableReadTimestampableBlameableRead
...
```typescript
import { ManufacturerMultipartReadFilmTranslatableReadTimestampableBlameableRead } from './api';

const instance: ManufacturerMultipartReadFilmTranslatableReadTimestampableBlameableRead = {
    id,
    name,
    primaryColor,
    secondaryColor,
