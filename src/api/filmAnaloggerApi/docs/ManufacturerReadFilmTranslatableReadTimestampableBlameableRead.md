# ManufacturerReadFilmTranslatableReadTimestampableBlameableRead
...
```typescript
import { ManufacturerReadFilmTranslatableReadTimestampableBlameableRead } from './api';

const instance: ManufacturerReadFilmTranslatableReadTimestampableBlameableRead = {
    id,
    name,
    primaryColor,
    secondaryColor,
