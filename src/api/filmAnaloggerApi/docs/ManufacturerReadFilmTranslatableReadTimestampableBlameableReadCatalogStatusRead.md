# ManufacturerReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    name,
    primaryColor,
    secondaryColor,
