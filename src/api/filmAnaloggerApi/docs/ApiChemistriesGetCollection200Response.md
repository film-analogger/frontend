...
**hydra_member** | [**Array&lt;ChemistryJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead&gt;**](ChemistryJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead.md) |  | [default to undefined]

## Example

```typescript
import { ApiChemistriesGetCollection200Response } from './api';

const instance: ApiChemistriesGetCollection200Response = {
    hydra_totalItems,
    hydra_search,
    hydra_view,
    hydra_member,
