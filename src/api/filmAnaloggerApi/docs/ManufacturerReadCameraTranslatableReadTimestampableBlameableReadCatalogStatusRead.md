# ManufacturerReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    name,
    primaryColor,
    secondaryColor,
