# ManufacturerMultipartReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerMultipartReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerMultipartReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    name,
    primaryColor,
    secondaryColor,
    tertiaryColor,
