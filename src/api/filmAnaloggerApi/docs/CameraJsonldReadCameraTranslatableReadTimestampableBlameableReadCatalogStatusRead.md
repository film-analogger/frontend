...
**manufacturer** | [**ManufacturerJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead**](ManufacturerJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead.md) |  | [default to undefined]
...
```typescript
import { CameraJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: CameraJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    id,
