# FilmJsonldReadManufacturerTimestampableBlameableReadTranslatableRead
...
```typescript
import { FilmJsonldReadManufacturerTimestampableBlameableReadTranslatableRead } from './api';

const instance: FilmJsonldReadManufacturerTimestampableBlameableReadTranslatableRead = {
    context,
    id,
    type,
    translations,
