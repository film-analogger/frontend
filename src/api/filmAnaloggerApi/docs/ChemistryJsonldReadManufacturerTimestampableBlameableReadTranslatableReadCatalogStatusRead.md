# ChemistryJsonldReadManufacturerTimestampableBlameableReadTranslatableReadCatalogStatusRead
...
```typescript
import { ChemistryJsonldReadManufacturerTimestampableBlameableReadTranslatableReadCatalogStatusRead } from './api';

const instance: ChemistryJsonldReadManufacturerTimestampableBlameableReadTranslatableReadCatalogStatusRead = {
    context,
    id,
    type,
    translations,
