# ManufacturerJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerJsonldReadCameraTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    createdBy,
