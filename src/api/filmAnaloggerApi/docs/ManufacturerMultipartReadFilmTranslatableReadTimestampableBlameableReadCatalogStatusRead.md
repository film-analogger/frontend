# ManufacturerMultipartReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerMultipartReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerMultipartReadFilmTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    name,
    primaryColor,
    secondaryColor,
