# ManufacturerReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    name,
    primaryColor,
    secondaryColor,
    tertiaryColor,
