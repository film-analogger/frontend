# ManufacturerJsonldReadEnlargerTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerJsonldReadEnlargerTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerJsonldReadEnlargerTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    id,
