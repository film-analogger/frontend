# ChemicalBathReadPrintSessionTimestampableBlameableRead
...
------------ | ------------- | ------------- | -------------
**chemistry** | [**ChemistryReadPrintSessionTimestampableBlameableRead**](ChemistryReadPrintSessionTimestampableBlameableRead.md) |  | [default to undefined]
...
```typescript
import { ChemicalBathReadPrintSessionTimestampableBlameableRead } from './api';

const instance: ChemicalBathReadPrintSessionTimestampableBlameableRead = {
    chemistry,
    dilutionOverride,
    durationSeconds,
    effectiveDilution,
