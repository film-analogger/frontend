# ManufacturerJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ManufacturerJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ManufacturerJsonldReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    context,
    id,
    type,
    name,
