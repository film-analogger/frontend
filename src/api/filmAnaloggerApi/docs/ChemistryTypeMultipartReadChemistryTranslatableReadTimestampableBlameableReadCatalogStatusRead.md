# ChemistryTypeMultipartReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead
...
```typescript
import { ChemistryTypeMultipartReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead } from './api';

const instance: ChemistryTypeMultipartReadChemistryTranslatableReadTimestampableBlameableReadCatalogStatusRead = {
    id,
    typeCode,
    typeLabel,
    translations,
